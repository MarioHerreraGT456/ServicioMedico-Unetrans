...
<div class="dashboard">
  ...
  <section id="view-inicio" class="view">
        ...
        <div class="profile-header-card-result" style="border-left: 5px solid #ffc107;">
            <div class="profile-photo-and-name-result">
                <div class="profile-avatar-result">
                    <img src="{{ asset('img/perfil.jpg') }}" alt="Foto Admin" style="width:120px; height:120px; border-radius:50%;">
                </div>
                <div class="profile-main-info-result">
                    <h2 class="profile-name-result">{{ Auth::guard('admin')->user()->usuario }}</h2>
    ...
    @endauth
      @if(isset($medico) && $medico->especialidad === 'general')
    ...
    @if(isset($medico) && $medico->especialidad === 'odontologia')
    ...
    @if(isset($medico) && $medico->especialidad === 'psiquiatria')
    ...
    @if(isset($medico) && $medico->especialidad === 'fisiatria')
    ...
    @if(isset($medico) && $medico->especialidad === 'traumatologia')
            ...
            @foreach($consultasPendientes as $consulta)
                ...
                <div class="waiting-card" id="consulta-{{ $consulta->id }}">
                        ...
                        <div class="waiting-info">
                            ...
                            <div class="waiting-row-bottom">
                                <span class="waiting-hora">
                                    Llegada: {{ \Carbon\Carbon::parse($consulta->created_at)->format('h:i A') }}
                                </span>
                    ...
                    <button 
                        ...
                        onclick="atenderConsulta({{ $consulta->id }})">
